...
const Skills = () => {
    ...
    return(
        <div className="section skills">
            ...
            <p>I am focusing on frontend development, but I think every frontend developer should have a tiny bit of backend experience, I have made a couple of servers (as API providers) in <span className="bold">Node.js</span> and <span className="bold">express.js</span>. <span className="silent"><a href="https://github.com/martinslaby70/calendar/blob/main/server.js" target="_blank">(simple code example)</a></span> And am currently working on a graphQL project with a more compact server-side</p>
