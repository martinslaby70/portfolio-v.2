    ...
    return(
        <div>
            ...
            >
                ...
                <a href="https://github.com/martinslaby70" target="_blank" rel="noopener noreferrer">Github</a>
                <a href="./imgs/resume.pdf" target="_blank">Checkout my resume</a>            
                <a href="/#" onClick={e => toggleTheme(e)} className="switcher" rel="noopener noreferrer">Switch to {theme === 'dark' ? 'light' : 'dark'} theme</a>
